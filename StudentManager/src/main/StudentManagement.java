...
public class StudentManagement {
 ...
 // kiểm tra tiền tố mã phù hợp với ngành
    ...
    private void seedData() {
        ...
        students.add(new Student("4551050001", normalizeName("Trần Kim Anh"), LocalDate.of(2001, 5, 12), "CNTT", 8.5, "CNTTK45A"));
        students.add(new Student("4551050002", normalizeName("Võ Văn Tín"), LocalDate.of(2002, 3, 3), "CNTT", 7.2, "CNTTK45A"));
        students.add(new Student("4551050003", normalizeName("Đào Trí Bảo"), LocalDate.of(2000, 12, 25), "CNTT", 9.1, "CNTTK45B"));
        students.add(new Student("4551090001", normalizeName("Lăng Tinh Khôi"), LocalDate.of(1999, 7, 8), "KTPM", 6.8, "KTPM47"));
        students.add(new Student("4551090002", normalizeName("Ngô Trọng Mạnh"), LocalDate.of(2003, 11, 2), "KTPM", 7.5, "KTPM47"));
        students.add(new Student("4551050004", normalizeName("Hà Lê Vân"), LocalDate.of(2001, 1, 17), "CNTT", 5.4, "CNTTK45B"));
        students.add(new Student("4551090003", normalizeName("Nguyễn Thị Đào"), LocalDate.of(2000, 9, 30), "KTPM", 8.0, "KTPM46"));
        students.add(new Student("4551050005", normalizeName("Phạm Minh Đức"), LocalDate.of(2002, 4, 5), "CNTT", 6.2, "CNTTK46A"));
        students.add(new Student("4551090004", normalizeName("Huỳnh Anh Khoa"), LocalDate.of(2001, 6, 18), "KTPM", 9.0, "KTPM45"));
        students.add(new Student("4551050006", normalizeName("Lê Trần Mai Linh"), LocalDate.of(2003, 8, 9), "CNTT", 7.9, "CNTTK46B"));
    }
